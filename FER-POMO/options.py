...
def get_options(args=None):
    ...
    ### overall settings
    parser.add_argument('--problem', default='cvrp', choices=['pdp', 'tsp', 'cvrp'],
    ...
    parser.add_argument('--pretrained', default='./pretrained/Saved_CVRP100_Model/ACTOR_state_dic.pt',
                       help='pretrained model from POMO')
    ...
    parser.add_argument('--batch_size', type=int, default=3,  # 512 1024
                        help='Number of instances per batch during training')
    parser.add_argument('--epoch_end', type=int, default=100,
                        help='End at epoch #')
    parser.add_argument('--epoch_size', type=int, default=10,  # 10 * batch_size
                        help='Number of instances per epoch during training')
    parser.add_argument('--val_size', type=int, default=2,  # 1000
                        help='Number of instances used for reporting validation performance')
    parser.add_argument('--eval_batch_size', type=int, default=2,  # 1000
    ...
    parser.add_argument('--feed_forward_dim', type=int, default=512, help='Dimension of feed forward layer')
